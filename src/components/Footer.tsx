...
export default async function Footer() {
    return (
        <section className="mt-48 relative inset-x-0 bottom-0 max-md:pb-10 pb-16">
            <div className="h-[100px] bg-inherit md:py-10 md:px-20 border border-t-gray-600 border-b-0 border-opacity-35">
                <div className="py-7 flex max-md:flex-col items-center justify-between max-md:gap-10 text-lg max-sm:tet-base text-black font-palanquin lg:px-20">
                    <div>
